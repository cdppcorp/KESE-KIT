...
| 9 | **Javascript 시큐어코딩 가이드** (2023년 개정본) | KISA | 2023 | 159 | [PDF](문서/Javascript_시큐어코딩_가이드(2023년_개정본).pdf) / [MD](문서/Javascript_시큐어코딩_가이드.md) |
| 10 | **Python 시큐어코딩 가이드** (2023년 개정본) | KISA | 2023 | 176 | [PDF](문서/Python_시큐어코딩_가이드(2023년_개정본).pdf) / [MD](문서/Python_시큐어코딩_가이드.md) |
